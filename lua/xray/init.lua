...
local function k_handler()
  local id = require("xray.util").cword_id()
  if id then
...
function M.setup(opts)
  ...
  require("xray.prefetch").setup()

  vim.defer_fn(function()
    pcall(function() require("xray.ui.picker").prefetch_list() end)
  end, 500)
...
function M.show(key)
  ...
  require("xray.hover").trigger(key)
end

function M.hover_or_fallback()
  require("xray.hover").hover_or_lsp()
end

function M.search()
  require("xray.ui.picker").open()
end

function M.insert_at_cursor(key)
  require("xray.insert").smart_insert(key)
end

function M.coverage()
  require("xray.pickers.coverage").run()
end
